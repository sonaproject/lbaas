...
class LbaasLoadbalancer(XOSResource):
    ...
    copyin_props = ("loadbalancer_id", "description", "vip_subnet_id", "vip_address", "admin_state_up", "operating_status", "provisioning_status")
...
class LbaasPool(XOSResource):
    ...
    xos_model = Pool
    copyin_props = ("pool_id", "health_monitor_id", "lb_algorithm", "description", "protocol", "admin_state_up", "subnet_id", "status")
...
class LbaasMember(XOSResource):
    ...
    xos_model = Member
    copyin_props = ("member_id", "pool_id", "subnet_id", "address", "protocol_port", "weight", "admin_state_up", "operating_status", "provisioning_status")
